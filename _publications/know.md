...
permalink: /publication/know
excerpt: 'Author: Wei Shao, **Zequan Liang**, Ruoyu Zhang, Ruijie Fang, Ning Miao, Ehsan Kourkchi, Setareh Rafatirad, Houman Homayoun, Chongzhou Fang'
date: 2025-08-19
venue: 'Network and Distributed Systems Security (NDSS) Symposium'
detail_paperurl: 'https://arxiv.org/abs/2508.13690'
---
[Paper Link]({{ page.detail_paperurl }})

![Model architecture]({{ '/images/publications/know.png' | relative_url }})
